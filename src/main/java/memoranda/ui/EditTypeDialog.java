...
public class EditTypeDialog extends JDialog {
	...
	void jbInit() throws Exception {
		...
		header.setIcon(
				new ImageIcon(main.java.memoranda.ui.EditTypeDialog.class.getResource("/ui/icons/resource48.png")));
	...
	void setIconB_actionPerformed(ActionEvent e) {
		 ...
		 * chooser.setCurrentDirectory(new File("C:\\Program Files")); } else
		 */
